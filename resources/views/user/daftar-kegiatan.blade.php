        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="logo-container flex items-center justify-center w-10 h-10 overflow-hidden">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('user.dashboard') }}" class="bg-white text-primary-700 hover:bg-primary-50 px-4 py-2 rounded-lg font-semibold transition-colors flex items-center">
                            ...
                            @elseif(isset($item['jenis']) && $item['jenis'] == 'penyewaan_vidotron')
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-xs text-gray-500">{{ $item['jenis_ppengusul'] }}</div>
                                    </td>
                                    <td class="px-6 py-4">
